...
export VERSION="T_01_12"

PYTHONPATH=$PWD python runner.py --n_estimators 100 --data_lengths 100 --random_state_gap 1 --random_state_begin $START --random_state_end $((START + GAP)) --last_rounds_begin 1176 --last_rounds_end 770 --db_file_path "/db/metrics.db" --version $VERSION
